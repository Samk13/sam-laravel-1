<nav class="bg-gray-800 mb-5 rounded-b-xl shadow-sm">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16">
      <div class="flex items-center">
        <div class="flex-shrink-0">
            <a href="/">
                <img class="block lg:hidden h-8 w-auto" src="/assets/logo.svg" alt="Workflow logo">
                <img class="hidden lg:block h-8 w-auto" src="/assets/logo.svg" alt="Workflow logo">
            </a>
        </div>
        <div class="hidden sm:block sm:ml-6">
          <div class="flex">
            <a href="/project" class="px-3 py-2 rounded-md text-sm font-medium leading-5 text-white bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Projects</a>
            <a href="/articles" class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Articles</a>
            ...
            <a href="/payment/create" class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">payment</a>
          </div>
        </div>
      </div>
...
{{--  --}}
  ...
  <div class="hidden sm:hidden">
    <div class="px-2 pt-2 pb-3">
      ...
      <a href="/payment" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">payment</a>
    </div>
