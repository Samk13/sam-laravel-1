...
@section('body')
<section class="bg-gray-900 h-screen md:px-5 pt-10 text-indigo-900 ">
    <div class="p-5 bg-yellow-500 rounded-lg space-y-4">
        <h1 class="uppercase text-3xl font-serif">Welcome Home</h1>
        ...
        <!-- <div class="bg-teal-900 text-pink-700"></div> -->
        <div  class="shadow-lg rounded-lg p-2 font-black">
        </div>
    </div>
</section>
